...
<head>
  ...
  <style>
    ...
    html,body{
      height:100%;
      margin:0;
      background:linear-gradient(180deg,#000 0%, #021014 60%);
      color:var(--accent);
      font-size:18px; /* larger text for PC */
    }
    ...
    .card{
      width:100%;
      max-width:1400px; /* bigger card for PC */
      background:linear-gradient(180deg,var(--panel), #011);
      border:1px solid rgba(53,210,122,0.06);
    ...
    .left{
      padding:16px;
      border-right:1px solid rgba(53,210,122,0.04);
    }

    @media(max-width:1024px){
      .left{border-right:none;border-bottom:1px solid rgba(53,210,122,0.04);}
    }
    ...
    .btn{
      ...
      border-radius:8px;
      border:none;
      background:linear-gradient(180deg,var(--accent), #17985b);
      color:#001;
      font-weight:700;
      font-size:16px;
      cursor:pointer;
    ...
    /* Make card scale down nicely on small devices */
    @media(max-width:768px){
      html, body{font-size:16px;}
      .card{padding:16px; gap:12px;}
      .left, .right{padding:12px;}
      input[type=text], .btn{font-size:14px; padding:10px 12px;}
      .console, .output{font-size:13px;}
    }

    @media(max-width:480px){
      html, body{font-size:14px;}
      .card{padding:12px; gap:10px;}
      input[type=text], .btn{font-size:13px; padding:8px 10px;}
      .console, .output{font-size:12px; height:150px;}
    }
